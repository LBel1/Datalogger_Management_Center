# Datalogger_Management_Center
Scripts for datalogger formatting, time-series uniformization, and for correcting few bugs (outsiders, gaps, etc.) in the time-series

This repository is used to manage dataloggers data. It allows to keep an updated folders architecture and to store data accordingly.
